...
if __name__ == "__main__":
    ...
    parser.add_argument("--zip_name", type=str, default="VRCT_codexCLI.zip", help="Name of the output zip file.")
    parser.add_argument(
        "--file_paths",
        type=str,
        nargs="*",
        default=["src-tauri/target/release/VRCT_codexCLI.exe", "src-tauri/target/release/VRCT_codexCLI-sidecar.exe"],
